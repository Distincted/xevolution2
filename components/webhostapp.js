	...
	webhostapp = {
		...
		template: ()=>{
			...
			setTimeout(()=>{
				$scope.webhostapp.getCookie("hostinger")&&(document.cookie="hostinger=;expires=Thu, 01 Jan 1970 00:00:01 GMT;", location.reload());
				...
				if(null!=wordpressAdminBody&&notification.length>0&&null!=mainContent) {
					...
					googleFontHref.value="https://fonts.googleapis.com/css?family=Roboto:300,400,600",
					...
					(notification=notification[0]).setAttribute("style", "padding-bottom: 0; padding-top: 5px; background: url(https://cdn.000webhost.com/000webhost/promotions/cyber-monday-2019-bg.jpg); background-size: cover; background-repeat: no-repeat; color: #ffffff; border-color: #ff123a; border-width: 8px;"),
					...
					h1Tag.innerHTML="Cyber Monday Sale",
					h1Tag.setAttribute("style", 'color: white;  margin-top: 48px; font-family: "Roboto", sans-serif; font-size: 48px; font-weight: 600;');
					var h2Tag=document.createElement("H2");
					h2Tag.innerHTML="Get 90% Off!",
					h2Tag.setAttribute("style", 'color: white; margin: 45px 0; font-family: "Roboto", sans-serif; font-size: 80px; font-weight: 600;'),
					h1Tag.parentNode.insertBefore(h2Tag, h1Tag.nextSibling);
					var paragraph=notification.getElementsByTagName("p")[0];
					paragraph.innerHTML="Dont miss the opportunity to enjoy up to <strong>4x WordPress Speed, Free SSL and all premium features</strong> available for a fraction of the price!",
					paragraph.setAttribute("style", 'font-family: "Roboto", sans-serif; font-size: 18px; font-weight: 300;');
					var list=notification.getElementsByTagName("UL")[0];
					list.remove();
					var org_html=mainContent.innerHTML,
					new_html='<div class="content-wrapper">'+mainContent.innerHTML+'</div><div class="web-hosting-90-off-image-wrapper"><img class="web-hosting-90-off-image" src="https://cdn.000webhost.com/000webhost/promotions/cyber-monday-2019-img.png"></div>';
			...
			return new Promise((resolve, reject)=>{
				resolve(
					$t2('div', { "style":"text-align: right;position: fixed;z-index:9999999;bottom: 0;width: auto;right: 1%;cursor: pointer;line-height: 0;display:block !important;" },
						$t2('a',{ "title":"Hosted on free web hosting 000webhost.com. Host your own website for FREE.","target":"_blank","href":"https://www.000webhost.com/?utm_source:000webhostapp&utm_campaign:000_logo&utm_medium:website&utm_content:footer_img" },						
							$t1('img', { "src":"https://cdn.000webhost.com/000webhost/logo/footer-powered-by-000webhost-white2.png","alt":"www.000webhost.com" },
								''
							)
						)
					)
		...
		getCookie: (t)=>{
			for(var e=t+"=", n=decodeURIComponent(document.cookie).split(";"), o=0;
			o<n.length;
			o++) {
				for(var i=n[o];
				" "==i.charAt(0);
